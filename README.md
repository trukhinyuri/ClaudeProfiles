...
Claude Profiles shares session cards only. It doesn’t copy Claude Desktop’s scheduled-task list into profiles, so tasks you created in the main app are listed there only.
